...
# -*- encoding: utf-8 -*-
# stub: tmx_data_update 0.3.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["TMX Credit", "Arthur Shagall", "Zach Belzer"]
  s.date = "2013-12-18"
  s.description = "Provides a clean way to handle updates to seed data post-launch."
  s.email = ["rubygems@tmxcredit.com", "arthur.shagall@gmail.com", "zbelzer@gmail.com"]
  s.extra_rdoc_files = [
    "LICENSE",
    "README.md"
  ]
